# -*- coding: utf-8 -*-
"""
Bayesian Gait Event Detector -- BIS (Bayesian with Improved Signals).

Extends the Bayesian V1 detector with 3 ratio-based velocity features
in Stage 2 (Bayesian event classification):
...
These features have high Cohen's d separation between HS and TO,
especially in pathological gait (PD, stroke).
