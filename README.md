...
Current status: PyPI release available (`gaitkit==1.4.9`), CRAN submission/update in progress.
...
If you use gaitkit in your research, please cite the current software release:
